...
def cmi_name():
    ...
    for ndc in ['chicago','ashburn','hillsboro']:
        project_id = 'e1b5ee09-dce1-4b7f-96fc-733350102960'
...
for x in json_data:
    ...
    if x['DC'] == 'as':
        cmi_loc = cmi[1]
        f.write(
            'url = "https://api.xcloud.comcast.com/api/terraformassist/v1/vRA/ashburn/az1/e1b5ee09-dce1-4b7f-96fc-733350102960"\n')
    elif x['DC'] == 'ho':
        cmi_loc = cmi[2]
        f.write(
            'url = "https://api.xcloud.comcast.com/api/terraformassist/v1/vRA/hillsboro/az1/e1b5ee09-dce1-4b7f-96fc-733350102960"\n')
    elif x['DC'] == 'ch' or x['DC'] == 'ch2':
        cmi_loc = cmi[0]
        f.write(
            'url = "https://api.xcloud.comcast.com/api/terraformassist/v1/vRA/chicago/az1/e1b5ee09-dce1-4b7f-96fc-733350102960"\n')
...
project = "BSD-Ops-non-prod-e1b5ee09-dce1-4b7f-96fc-733350102960"\n''')
    ...
    f.write('tenant = "BSD_DE_Non_Prod"\n')
    f.write('rail = "' + x['Rail'] + '"\n')
