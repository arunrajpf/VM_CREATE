...
for x in json_data:
    ...
    if x['DC'] == 'as':
        cmi_loc = cmi[1]
        f.write(
            'url = "https://api.xcloud.comcast.com/api/terraformassist/v1/vRA/ashburn/az2/b25e1598-8cd0-4192-8831-26de390d427e"\n')
    elif x['DC'] == 'ho':
        cmi_loc = cmi[2]
        f.write(
            'url = "https://api.xcloud.comcast.com/api/terraformassist/v1/vRA/hillsboro/az2/b25e1598-8cd0-4192-8831-26de390d427e"\n')
    elif x['DC'] == 'ch' or x['DC'] == 'ch2':
        cmi_loc = cmi[0]
        f.write(
            'url = "https://api.xcloud.comcast.com/api/terraformassist/v1/vRA/chicago/az2/b25e1598-8cd0-4192-8831-26de390d427e"\n')
