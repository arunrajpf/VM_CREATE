...
for x in json_data:
    ...
    if x['DC'] == 'as':
        cmi_loc = cmi[1]
        f.write(
            'url = "https://api.xcloud.comcast.com/api/terraformassist/v1/vRA/ashburn/az2/feee17ca-e8df-46d9-a392-e7766d1209ae"\n')
    elif x['DC'] == 'ho':
        cmi_loc = cmi[2]
        f.write(
            'url = "https://api.xcloud.comcast.com/api/terraformassist/v1/vRA/hillsboro/az2/feee17ca-e8df-46d9-a392-e7766d1209ae"\n')
    elif x['DC'] == 'ch' or x['DC'] == 'ch2':
        cmi_loc = cmi[0]
        f.write(
            'url = "https://api.xcloud.comcast.com/api/terraformassist/v1/vRA/chicago/az2/feee17ca-e8df-46d9-a392-e7766d1209ae"\n')
    f.write('''insecure = "false"
project = "BSD-Ops-prod-feee17ca-e8df-46d9-a392-e7766d1209ae"\n''')
    now = datetime.now()
    current_time = now.strftime("%Y%m%d%H%M%S")
    f.write('deployment_name = "BSD-Ops-prod-' + current_time + '"\n')
