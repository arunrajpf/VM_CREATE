...
def cmi_name(os_name):
    ...
    for ndc in ['chicago','ashburn','hillsboro']:
        project_id = 'f7f17844-8011-4da8-9cef-8dedae06ee62'
...
for x in json_data:
    ...
    if x['DC'] == 'as':
        cmi_loc = cmi[1]
        f.write(
            'url = "https://api.xcloud.comcast.com/api/terraformassist/v1/vRA/ashburn/az2/f7f17844-8011-4da8-9cef-8dedae06ee62"\n')
    elif x['DC'] == 'ho':
        cmi_loc = cmi[2]
        f.write(
            'url = "https://api.xcloud.comcast.com/api/terraformassist/v1/vRA/hillsboro/az2/f7f17844-8011-4da8-9cef-8dedae06ee62"\n')
    elif x['DC'] == 'ch' or x['DC'] == 'ch2':
        cmi_loc = cmi[0]
        f.write(
            'url = "https://api.xcloud.comcast.com/api/terraformassist/v1/vRA/chicago/az2/f7f17844-8011-4da8-9cef-8dedae06ee62"\n')
    f.write('''insecure = "false"
project = "BSD-Workbench-non-prod-f7f17844-8011-4da8-9cef-8dedae06ee62"\n''')
    now = datetime.now()
    current_time = now.strftime("%Y%m%d%H%M%S")
    f.write('deployment_name = "BSD-Workbench-non-prod-' + current_time + '"\n')
