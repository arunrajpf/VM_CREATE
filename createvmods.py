...
def cmi_name(os_name):
    ...
    for ndc in ['chicago','ashburn','hillsboro']:
        for az in [1,2]:
            ...
            httpresp = requests.post('https://api.xcloud.comcast.com/api/catalog/v2/catalogItems/forms/render?az=az' + str(az) +'&region='+ ndc +'&projectId=' + project_id,  data = d, headers=headers)
            print(httpresp.text)
            sleep(10)
...
AZURE_CLIENT_ID = "127d13b2-bf0c-4252-98e4-7b402ea66efe"
AZURE_CLIENT_SECRET = "S-67Q~Q7WZP9Z0s8fjfLHfeer4ngOOZK0glQp"
